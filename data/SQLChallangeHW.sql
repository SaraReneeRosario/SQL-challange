...
CREATE TABLE titles(
	...
	--Primary Key (title),
	--FOREIGN KEY (title_id)  REFERENCES employees (title_id)  ON DELETE CASCADE);
...
--This code was adapted from the following https://github.com/feelingsunny/Employee-SQL-Data/blob/master/query.sql